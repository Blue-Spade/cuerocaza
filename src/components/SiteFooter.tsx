  ...
  return (
    <footer className="mt-32 border-t border-border/60 bg-espresso">
      <div className="mx-auto grid max-w-7xl gap-12 px-6 py-16 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-4 max-w-md text-sm leading-relaxed text-cream/70">
            CUEROCAZA is a Dubai-based premium leather brand specialising in genuine Italian leather wallets,
            passport covers, card holders, personalised gifts, and corporate leather gifting solutions across the UAE.
          </p>
          <p className="mt-4 text-sm text-cream/70">
            ...
            >
              39 6th St — Al Murar — Dubai — United Arab Emirates
            </a>
          </p>
          <div className="mt-6 flex flex-wrap items-center gap-3">
            <a
              ...
              onClick={(e) => { e.preventDefault(); const opened = window.open("https://wa.me/971561153442", "_blank", "noopener,noreferrer"); if (!opened) window.location.assign("https://wa.me/971561153442"); }}
            ...
            <a
              ...
              onClick={(e) => { e.preventDefault(); const opened = window.open("https://www.facebook.com/share/1BwPpZ5UZp/", "_blank", "noopener,noreferrer"); if (!opened) window.location.assign("https://www.facebook.com/share/1BwPpZ5UZp/"); }}
            ...
            <a
              ...
              onClick={(e) => { e.preventDefault(); const opened = window.open("https://www.instagram.com/cuerocaza?igsh=MXBjMWd1cm9zOG1xdQ==", "_blank", "noopener,noreferrer"); if (!opened) window.location.assign("https://www.instagram.com/cuerocaza?igsh=MXBjMWd1cm9zOG1xdQ=="); }}
              className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-[#E1306C] text-white transition hover:opacity-90"
            >
            ...
            <a
              ...
              onClick={(e) => { e.preventDefault(); const opened = window.open("https://www.youtube.com/@cuerocaza", "_blank", "noopener,noreferrer"); if (!opened) window.location.assign("https://www.youtube.com/@cuerocaza"); }}
              className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-[#FF0000] text-white transition hover:opacity-90"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn: Nasir J"
              title="LinkedIn: Nasir J"
              onClick={(e) => { e.preventDefault(); const opened = window.open("https://www.linkedin.com/in/nasir-j-realtor-with-integrity-5067b8143", "_blank", "noopener,noreferrer"); if (!opened) window.location.assign("https://www.linkedin.com/in/nasir-j-realtor-with-integrity-5067b8143"); }}
              className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-[#0A66C2] text-white transition hover:opacity-90"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4" aria-hidden="true"><path d="M20.45 20.45h-3.55v-5.57c0-1.33-.02-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.36V9h3.41v1.56h.05c.48-.9 1.64-1.85 3.38-1.85 3.61 0 4.28 2.38 4.28 5.47v6.27zM5.34 7.43a2.06 2.06 0 11.001-4.121 2.06 2.06 0 010 4.121zM7.12 20.45H3.56V9h3.56v11.45zM22.22 0H1.77C.79 0 0 .78 0 1.74v20.51C0 23.21.79 24 1.77 24h20.45c.98 0 1.78-.79 1.78-1.75V1.74C24 .78 23.2 0 22.22 0z"/></svg>
            </a>
            <a
              ...
              onClick={(e) => { e.preventDefault(); const opened = window.open("https://www.tiktok.com/@leather160", "_blank", "noopener,noreferrer"); if (!opened) window.location.assign("https://www.tiktok.com/@leather160"); }}
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-cream/80">
            ...
            <li><Link to="/contact">Corporate Gifts</Link></li>
          </ul>
        </div>
        <div>
      ...
      <div className="border-t border-cream/10 px-6 py-6 text-center text-xs text-cream/50">
        © {new Date().getFullYear()} CUEROCAZA · Handcrafted Italian Leather Dubai.
      </div>
    </footer>
  );
}
