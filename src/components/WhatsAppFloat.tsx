export function WhatsAppFloat() {
  const phone = "971561153442";
  const message = encodeURIComponent("Hello Cuerocaza, I'd like to know more about your leather goods.");
  // wa.me works universally on desktop, mobile and tablet (opens app on phones, web on laptops)
  ...
  return (
    <a
      ...
      onClick={handleClick}
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-warm transition hover:scale-110 hover:shadow-elev"
    >
